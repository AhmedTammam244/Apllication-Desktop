...
public class UpdateFull_product_store implements ActionListener{
JFrame frame, frame1;
...
String sql =  "UPDATE `deprecition` SET `batch`="+batchh+",`size`="+sizee+",`deprecition`="+deprecitionn +"WHERE `batch`= "+batchh;
...
public static void main(String args[]){
	UpdateFull_product_store sr = new UpdateFull_product_store();
sr.createUI(); 
}
}